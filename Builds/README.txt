...
# Command Line Arguments
	# IMPORTANT:
		Do not use spaces in one arg, only between them. This will eventually be automated by the hub.
		Always use: start SS3D.exe before the args.

	# USERNAME:
		-ckey=username
		Example: if my username is john, I'll do: 
		start SS3D.exe -ckey=john

	# SERVER IP
		-ip=ip
		Example: if I want to join 192.168.0.1:50, I'll do: 
		start SS3D.exe -ip=192.168.0.1:50
