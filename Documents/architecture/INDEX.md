...
| Inventory | [inventory](systems/inventory.md) | partial | Items/containers/hands; Main HUD UITK overlay (Resources catalog); HUD suppressed while machine UI open; legacy HUD uGUI condemned; Human hands wiring is prefab debt |
...
| [2026-07_ci-develop-release-pipeline](2026-07_ci-develop-release-pipeline.md) | shipped (manual workflow_dispatch; default build-only Linux→Windows+bats; EditMode/smoke opt-in; Linux zips secondary) |
