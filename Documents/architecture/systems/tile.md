...
- React to placement: implement `ITileMutationObserver` (see [electricity](electricity.md)).
...
- **Used by:** [electricity](electricity.md), [furniture](furniture.md), [substances](substances.md)

## Related docs

- Design (read-only): [Documents/design/area.md](../../design/area.md) (not yet implemented)
