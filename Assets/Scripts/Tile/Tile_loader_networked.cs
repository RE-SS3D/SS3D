...
namespace Mirror{
    ...
    public class Tile_loader_networked : NetworkBehaviour
    {
        ...
        private void Awake() {
            ClientScene.RegisterPrefab(empty_tile);
        }
        ...
        {   
            ...
            new_obj.GetComponent<Tile>().initTile(new_obj.GetComponent<Tile>().type_index);
