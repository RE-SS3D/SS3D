...
namespace SS3D.Systems.Inventory.Items.Generic
{
    ...
    public class BikeHorn : Item
    {
        ...
        public void Honk()
        {
            ...
            AudioClip bikeHornClip = Assets.Get<AudioClip>(AssetDatabases.InteractionIcons, InteractionIcons.Take);
            SubSystems.Get<AudioSubSystem>().PlayAudioSource(AudioType.Sfx, bikeHornClip, GameObject.transform.position, NetworkObject, false, 0.7f, 1, 1, 5);
        }
