...
namespace SS3D.Systems.Inventory.UI
{
    ...
    /// </summary>
    public class ItemDisplayAlt : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerDownHandler, IPointerClickHandler
    {
        ...
        public void OnEndDrag(PointerEventData eventData)
        {
            ...
            if (o == null)
            {
                GetComponentInParent<InventoryDisplayElementAlt>().DropItemOutside(Item);
            }
        }
