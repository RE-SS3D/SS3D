...
namespace SS3D.Systems.Tile
{
    ...
    public class TileChunk: NetworkBehaviour
    {
        ...
        public void SetTileObject(TileLayer layer, int x, int y, ITileLocation value)
        {
            ...
            {
                Punpun.Warning(Subsystems.Get<TileSystem>(), "Tried to set tile object outside of chunk boundary");
            }
        }
        ...
        public ITileLocation GetTileLocation(TileLayer layer, int x, int y)
        {
            ...
            {
                Punpun.Warning(Subsystems.Get<TileSystem>(), "Tried to get tile object outside of chunk boundary");
                return default;
            }
        }
