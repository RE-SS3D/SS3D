...
namespace SS3D.Systems.Tile.Connections
{
    ...
    /// </summary>
    public class AdvancedAdjacencyConnector : AbstractHorizontalConnector, IAdjacencyConnector, IEngineDrivenAdjacency
    {
        ...
        public IMeshAndDirectionResolver MeshResolver => advancedAdjacency;

        private void Awake()
        {
            GetOrCreateAdjacencyView().Configure(advancedAdjacency);
        }
