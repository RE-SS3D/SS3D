...
namespace SS3D.Systems.Tile.Connections.AdjacencyTypes
{
    ...
    public struct AdvancedConnector : IMeshAndDirectionResolver
    {
        ...
        [Tooltip("A mesh where South and North edges are connected")]
        public Mesh i;

        [Tooltip("A mesh where the South and West edges are connected, no corners")]
        public Mesh lNone;
        [Tooltip("A mesh where the South and West edges are connected, and SW is a corner")]
        public Mesh lSingle;

        [Tooltip("A mesh where the South, West, and East edges are connected, no corners")]
        public Mesh tNone;
        [Tooltip("A mesh where the South, West, and East edges are connected, SW is a corner")]
        public Mesh tSingleRight;
        [Tooltip("A mesh where the South, West, and East edges are connected, SE is a corner")]
        public Mesh tSingleLeft;
        [Tooltip("A mesh where South, West, and East edges are connected, SW & SE are corners")]
        public Mesh tDouble;
        ...
        public Mesh xSingle;
        [Tooltip("A mesh where all edges are connected, SW & SE are corners")]
        public Mesh xSide;
        ...
        public MeshDirectionInfo GetMeshAndDirection(AdjacencyMap adjacencyMap)
        {
            ...
            if (opaque)
            {
                switch (shape)
                {
                    // View obstacles likely need resolving after switching around adjacency connections.
                    case AdjacencyShape.U:
