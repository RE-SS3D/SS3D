...
namespace SS3D.Systems.IngameConsoleSystem
{
    public class ConsolePanelView : Actor
    {
        ...
        /// </summary>
        [SerializeField]
        private float _movingSpeed = 2500f;
        [SerializeField]
        ...
        [SerializeField]
        private List<string> _allPrevCommands = new()
        {
            string.Empty,
        };
        ...
        public void ProcessCommand(string command)
        {
            ...
            _allPrevCommands.Add(string.Empty);
        ...
        private void HandleClose(InputAction.CallbackContext context)
        {
            ...
            _inputSystem.ToggleActionMap(_consoleControls, false, new InputAction[]
            {
                _consoleControls.Open,
            });
        }
        ...
        private void HandleOpen(InputAction.CallbackContext context)
        {
            ...
            _inputSystem.ToggleActionMap(_consoleControls, true, new InputAction[]
            {
                _consoleControls.Open,
            });
        ...
        {
            _chosenPrevCommand = Math.Clamp(_chosenPrevCommand + (int)context.ReadValue<float>(), 0, _allPrevCommands.Count - 1);
