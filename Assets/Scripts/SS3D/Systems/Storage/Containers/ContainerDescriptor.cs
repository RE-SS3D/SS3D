...
namespace SS3D.Systems.Storage.Containers
{
    ...
    public class ContainerDescriptor : MonoBehaviour
    {
        ...
        public void Awake()
        {
            ...
            OpenIcon = AssetData.Icons.Get(InteractionIcons.Open);
            TakeIcon = AssetData.Icons.Get(InteractionIcons.Take);
            StoreIcon = AssetData.Icons.Get(InteractionIcons.Take);
            ViewIcon = AssetData.Icons.Get(InteractionIcons.Open);
        }
    }
}
