...
{
    public sealed class BurnDressingItemExtension : MonoBehaviour, IInteractionSourceExtension
    {
        private static readonly BurnDressingInteraction Interaction = new();
