...
namespace SS3D.Systems.Screens
{
    ...
    public class CameraFollow : Actor
    {
        ...
        {
            _horizontalAngle = (_horizontalAngle + (_controls.HorizontalRotation.ReadValue<float>() * HorizontalRotationSensitivity * Time.deltaTime)) % 360;
            _verticalAngle = Mathf.Clamp(_verticalAngle + (_controls.VerticalRotation.ReadValue<float>() * VerticalRotationSensitivity * Time.deltaTime), MinVerticalAngle, MaxVerticalAngle);
            ...
            _currentVerticalAngle = Mathf.LerpAngle(_currentVerticalAngle, _verticalAngle, Time.deltaTime * AngleAcceleration);
