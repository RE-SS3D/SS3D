...
namespace SS3D.Interactions
{
    ...
    public class Interaction : IInteraction
    {
        ...
        /// </summary>
        [NotNull]
        public virtual IClientInteraction CreateClient(InteractionEvent interactionEvent) => new ClientDelayedInteraction();
        ...
        public virtual string GetName(InteractionEvent interactionEvent) => throw new NotImplementedException();

        /// <summary>
        /// Gets the interaction icon
        /// </summary>
        public virtual Sprite GetIcon(InteractionEvent interactionEvent) => throw new NotImplementedException();
        ...
        public virtual bool CanInteract(InteractionEvent interactionEvent) => throw new NotImplementedException();
        ...
        public virtual bool Start(InteractionEvent interactionEvent, InteractionReference reference) => throw new NotImplementedException();
        ...
        /// <param name="reference"></param>
        /// <returns>If the interaction should continue running</returns>
        public virtual bool Update(InteractionEvent interactionEvent, InteractionReference reference) => true;
