...
namespace UDiscord
{
    ...
    public partial class ActivityManager
    {
        ...
        internal partial struct FFIMethods
        {
            ...
            [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
            internal delegate void UpdateDiscordActivityMethod(IntPtr methodsPtr, ref Activities activity, IntPtr callbackData, UpdateActivityCallback callback);
            ...
            internal UpdateDiscordActivityMethod UpdateDiscordActivity;
        ...
        public void UpdateDisActivity(Activities activity, UpdateActivityHandler callback)
        {
            GCHandle wrapped = GCHandle.Alloc(callback);
            Methods.UpdateDiscordActivity(MethodsPtr, ref activity, GCHandle.ToIntPtr(wrapped), UpdateActivityCallbackImpl);
        }
